  ...
  return shell(
    <>
      <div className="ma-note blue">
        ...
        Join a team of {rule.team_size}. Once your class tutor sends the list
          ...
          <span>
            {myTeam
              ? data.formation_closed
                ...
                : "You can leave until your class tutor closes formation."
              : data.formation_closed
                ? "your class tutor will place you."
                : "If you do not join, your class tutor places you."}
          </span>
          <div style={{ flex: 1 }} />
